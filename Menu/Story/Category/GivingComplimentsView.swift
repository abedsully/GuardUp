...
struct GivingComplimentsView: View {
    ...
    private var stories: [Story] {
        [
            ...
            Story(text: "Devano takes a deep breath and decides to say something ...", image: "compliment-story-2"),
            
            Story(text: "How should Devano start the conversation?", image: "compliment-story-1", answers: ["Hey, Mario, I love your smile, it really brightens the room!", "You're always lonely. Shame on you!"], trueAnswer: "Hey, Mario, I love your smile, it really brightens the room!"),
            
            Story(image: isCorrectAnswer == true ? "compliment-story-3-true" : "compliment-story-3-false"),
            
            Story(text: isCorrectAnswer == true ? "Mario looks up, surprised, but then smiles. He seems to relax a bit, sitting up straighter, and makes eye contact with Devano." : "Mario flinches at Devano’s words, visibly uncomfortable.", image: isCorrectAnswer == true ? "compliment-story-4-true" : "compliment-story-4-false"),
            
            Story(text: isCorrectAnswer == true ? "Devano and Mario continue talking for a few minutes. Mario seems comfortable now, and the mood has lightened." : "Mario feels sad and immediately gets away from the room", image: isCorrectAnswer == true ? "compliment-story-5-true" : "compliment-story-5-false")
        ]
    }
