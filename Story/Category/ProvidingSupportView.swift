...
struct ProvidingSupportView: View {
    ...
    private var stories: [StoryConstant] {
        [
            StoryConstant(text: "Devano opens his smartphone in his leisure times. He notices there are 2 new messages in his Messages App and decides to open it", image: "support-story-1"),
            
            StoryConstant(text: "Oohh, It's from Mario. Devano reads the messages and watches Mario's vlog ...", image: "support-story-2"),
            
            StoryConstant(text: "How should Devano react to the message?", image: "support-story-3", answers: ["Yo, this vlog is so good, it’s like you’re a natural-born star 😜", "I've seen more excitement in a tutorial on how to fold socks—seriously, where’s the energy? 😬"], trueAnswer: "Yo, this vlog is so good, it’s like you’re a natural-born star 😜"),
            
            StoryConstant(image: isCorrectAnswer == true ? "support-story-4-true" : "support-story-4-false"),
            
            StoryConstant(text: isCorrectAnswer == true ? "Mario is happy and he is even more excited to vlog again..." : "Mario seems sad and unappreciated", image: isCorrectAnswer == true ? "support-story-5-true" : "support-story-5-false"),
        ]
    }
